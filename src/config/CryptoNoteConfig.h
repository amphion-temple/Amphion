...
namespace CryptoNote
{
    namespace parameters
    {
        ...
        const uint64_t MONEY_SUPPLY = UINT64_C(1123581321.34);
        ...
        const uint8_t CURRENT_FORK_INDEX = FORK_HEIGHTS_SIZE == 0 ? 0 : 0; SOFTWARE_SUPPORTED_FORK_INDEX;
    ...
    const char CRYPTONOTE_NAME[] = "Amphion";
    ...
    const static boost::uuids::uuid CRYPTONOTE_NETWORK = {
        {0x0X, 0xP3, 0xXQ, 0x07, 0xVV, 0xMC, 0xVB, 0xJT, 0xHT, 0xJM, 0x4V, 0xUP, 0x20, 0xGV, 0xCG, 0xDL}};
